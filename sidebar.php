      ...
      <nav class="mt-2">
        ...
        <?php if($_SESSION['login_type'] == 1): ?>
          ...
          <li class="nav-item"> 
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="./index.php?page=ticket" class="nav-link nav-new_customer tree-item">
                  <i class="fas fa-angle-right nav-icon"></i>
                  <p>Tickets</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="./index.php?page=ticket_management" class="nav-link nav-customer_list tree-item">
                  <i class="fas fa-angle-right nav-icon"></i>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="./index.php?page=products" class="nav-link nav-new_ticket tree-item">
                  <i class="fas fa-angle-right nav-icon"></i>
                  <p>Products</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="./index.php?page=orders" class="nav-link nav-ticket_list tree-item">
                  <i class="fas fa-angle-right nav-icon"></i>
                  <p>Orders</p>
                </a>
              </li>    
        ...
        <?php if($_SESSION['login_type'] == 2): ?>
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="./index.php?page=delivery_list" class="nav-link nav-ticket_list tree-item">
                  <i class="fas fa-angle-right nav-icon"></i>
                  <p>List</p>
                </a>
              </li>
          ...
          <li class="nav-item"> 
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="./index.php?page=new_ticket" class="nav-link nav-new_customer tree-item">
                  <i class="fas fa-angle-right nav-icon"></i>
                  <p>Tickets</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="./index.php?page=ticket_list_staff" class="nav-link nav-ticket_list tree-item">
                  <i class="fas fa-angle-right nav-icon"></i>
                  <p>List</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            ...
            <!--   <li class="nav-item">
                <a href="./index.php?page=issues" class="nav-link nav-ticket_list tree-item">
                  <i class="fas fa-angle-right nav-icon"></i>
                  <p>Issues</p>
                </a>
              </li> -->
